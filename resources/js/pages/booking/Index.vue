...
watch([selectedZoneId, selectedSpaceId, bookingDate, selectedTime], saveDraft, { deep: true });

const selectZone = (zone: Zone) => { selectedZoneId.value = zone.id; selectedSpaceId.value = null; };
const continueToPayment = () => {
    if (!canContinue.value) { error.value = 'Lengkapi area, space, tanggal, dan jam terlebih dahulu.'; return; }
    saveDraft();
